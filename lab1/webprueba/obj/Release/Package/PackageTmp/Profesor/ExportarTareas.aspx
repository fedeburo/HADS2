<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportarTareas.aspx.cs" Inherits="webprueba.Profesor.ExportarTareas" %>
    ...
    <form id="form2" runat="server">
        <div style="height: 415px">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="94px">
                <asp:Panel ID="Panel4" runat="server" Height="81px" Width="781px">
                    &nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Profesor/Profesor.aspx">Volver a Inicio</asp:HyperLink>
                    &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Black" Text="PROFESOR-EXPORTAR TAREAS"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:Panel ID="Panel2" runat="server" Height="192px" Width="393px" float="left">
                ...
                <br />
                <br />
                <asp:Button ID="btnExportarXML" runat="server" Text="Exportar XML" OnClick="btnExportarXML_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnExportarJSON" runat="server" OnClick="btnExportarJSON_Click" Text="Exportar JSON" />
                <br />
                <br />
                <br />
                <br />
